...
{
	public class NESConsoles : GameConsole, IItemStatus
	{
		public NESConsoles() { }
		public NESConsoles(int consoleID, string consoleModel, int releaseYear, string manufacturer) : base(consoleID, consoleModel, releaseYear, manufacturer) { }

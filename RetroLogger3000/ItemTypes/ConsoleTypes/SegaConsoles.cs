...
{
	public class SegaConsoles : GameConsole, IItemStatus
	{
		public SegaConsoles() { }
		public SegaConsoles(int consoleID, string consoleModel, int releaseYear, string manufacturer) : base(consoleID, consoleModel, releaseYear, manufacturer) { }

...
{
	public class PlaystationConsoles : GameConsole, IItemStatus
	{
		public PlaystationConsoles() { }
		public PlaystationConsoles(int consoleID, string consoleModel, int releaseYear, string manufacturer) : base(consoleID, consoleModel, releaseYear, manufacturer) { }

...
{
	public class SNESConsoles : GameConsole, IItemStatus
	{
		public SNESConsoles() { }
		public SNESConsoles(int consoleID, string consoleModel, int releaseYear, string manufacturer) : base(consoleID, consoleModel, releaseYear, manufacturer) { }

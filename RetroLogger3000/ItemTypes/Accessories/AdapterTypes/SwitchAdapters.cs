...
{
	public class SwitchAdapters : Adapter, IItemStatus
	{
		public SwitchAdapters() { }
		public SwitchAdapters(int adapterID, string adapterModel, string manufacturer) : base(adapterID, adapterModel, manufacturer) { }

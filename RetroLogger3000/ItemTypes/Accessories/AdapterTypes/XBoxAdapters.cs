...
{
	public class XBoxAdapters : Adapter, IItemStatus
	{
		public XBoxAdapters() { }
		public XBoxAdapters(int adapterID, string adapterModel, string manufacturer) : base(adapterID, adapterModel, manufacturer) { }

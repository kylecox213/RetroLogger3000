...
{
	public class SNESAdapters : Adapter, IItemStatus
	{
		public SNESAdapters() { }
		public SNESAdapters(int adapterID, string adapterModel, string manufacturer) : base(adapterID, adapterModel, manufacturer) { }

...
{
	public class PlaystationCables : Cable, IItemStatus
	{
		public PlaystationCables() { }
		public PlaystationCables(int cableID, string cableModel, string manufacturer) : base(cableID, cableModel, manufacturer) { }

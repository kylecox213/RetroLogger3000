...
{
	public class SegaPeripherals : Peripheral, IItemStatus
	{
		public SegaPeripherals() { }
		public SegaPeripherals(int peripheralID, string peripheralModel, string manufacturer) : base(peripheralID, peripheralModel, manufacturer) { }

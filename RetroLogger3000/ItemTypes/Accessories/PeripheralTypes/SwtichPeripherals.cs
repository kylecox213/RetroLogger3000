...
{
	public class SwitchPeripherals : Peripheral, IItemStatus
	{
		public SwitchPeripherals() { }
		public SwitchPeripherals(int peripheralID, string peripheralModel, string manufacturer) : base(peripheralID, peripheralModel, manufacturer) { }

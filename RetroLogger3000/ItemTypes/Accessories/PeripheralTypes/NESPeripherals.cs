...
{
	public class NESPeripherals : Peripheral, IItemStatus
	{
		public NESPeripherals() { }
		public NESPeripherals(int peripheralID, string peripheralModel, string manufacturer) : base(peripheralID, peripheralModel, manufacturer) { }

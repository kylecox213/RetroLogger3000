...
{
	public class XBoxPeripherals : Peripheral, IItemStatus
	{
		public XBoxPeripherals() { }
		public XBoxPeripherals(int peripheralID, string peripheralModel, string manufacturer) : base(peripheralID, peripheralModel, manufacturer) { }

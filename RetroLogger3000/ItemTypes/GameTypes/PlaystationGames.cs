...
namespace RetroLogger3000.GameTypes
{
	public class PlaystationGame : Game, IGameStatus
	{
		public PlaystationGame() { }
		public PlaystationGame(int gameID, string title, int releaseYear, string platform, string publisher, string developer, int rank, int score)

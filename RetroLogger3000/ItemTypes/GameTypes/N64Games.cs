...
{
	public class N64Game : Game, IGameStatus
	{
		public N64Game() { }
		public N64Game(int gameID, string title, int releaseYear, string platform, string publisher, string developer, int rank, int score)

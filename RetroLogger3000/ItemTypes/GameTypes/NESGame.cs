...
{
	public class NESGame : Game, IGameStatus
	{
		public NESGame() { }
		public NESGame(int gameID, string title, int releaseYear, string platform, string publisher, string developer, int rank, int score)  

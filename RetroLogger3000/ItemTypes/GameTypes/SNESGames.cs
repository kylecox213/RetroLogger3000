...
{
	public class SNESGame : Game, IGameStatus
	{
		public SNESGame() { }
		public SNESGame(int gameID, string title, int releaseYear, string platform, string publisher, string developer, int rank, int score)

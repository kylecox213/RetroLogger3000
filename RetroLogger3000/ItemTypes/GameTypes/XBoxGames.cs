...
{
	public class XBoxGame : Game, IGameStatus
	{
		public XBoxGame() { }
		public XBoxGame(int gameID, string title, int releaseYear, string platform, string publisher, string developer, int rank, int score)

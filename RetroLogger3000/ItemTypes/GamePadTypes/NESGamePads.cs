...
{
	public class NESGamePads : GamePad, IItemStatus
	{
		public NESGamePads() { }
		public NESGamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }

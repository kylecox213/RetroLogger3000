...
{
	public class SegaGamePads : GamePad, IItemStatus
	{
		public SegaGamePads() { }
		public SegaGamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }

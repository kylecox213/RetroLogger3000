...
{
	public class SwitchGamePads : GamePad, IItemStatus
	{
		public SwitchGamePads() { }
		public SwitchGamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }

...
{
	public class SNESGamePads : GamePad, IItemStatus
	{
		public SNESGamePads() { }
		public SNESGamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }

...
{
	public class N64GamePads : GamePad, IItemStatus
	{
		public N64GamePads() { }
		public N64GamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }

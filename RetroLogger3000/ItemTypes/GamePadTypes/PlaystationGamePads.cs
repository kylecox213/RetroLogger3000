...
{
	public class PlaystationGamePads : GamePad, IItemStatus
	{
		public PlaystationGamePads() { }
		public PlaystationGamePads(int gamePadID, string gamePadModel, int releaseYear, string manufacturer) : base(gamePadID, gamePadModel, releaseYear, manufacturer) { }
